  ...
  <div>
    ...
    <TopNavBar/>
      <section class="fruit_section min-vh-100">
        <div class="container">
          <h2 class="custom_heading mt-3">Resources <span style="font-weight: 400;font-size: 18px;">{{filterTable.length}} Documents</span></h2>
  ...
  methods:{
    getAllPosts(){
        ...
        downloadPolicy(filelocation){
              window.open(`${axios.defaults.baseURL}/static/Libraries/${filelocation}`, '_blank');
        }
  },
  computed:{
        filterTable(){
